...
```sh
    ...
    return
```
At the end of each "day" the energy is replenished back to 3, just before a `day_change` is called. <p align="right">(Refer to <a href="https://github.com/Azraelbazrael/MiraCafe/edit/main/DOCUMENTATION.md#calendar">the Calender</a> for more information)</p>
```sh
label next_day:
